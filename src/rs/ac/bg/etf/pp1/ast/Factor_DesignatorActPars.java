...
public class Factor_DesignatorActPars extends Factor {

    private Designator Designator;
    private OptionalActPars OptionalActPars;

    public Factor_DesignatorActPars (Designator Designator, OptionalActPars OptionalActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("Factor_DesignatorActPars(\n");
